...
- `deploy/scripts/complete-operation-activities.sh <operation:agent-task:id>...` - host/deploy-context helper that runs from deploy-owned prod source, backs up live SQLite, and marks Codex operation activities as `Done`.
