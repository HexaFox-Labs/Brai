import { Archive, Eye, Settings, SquareTerminal, Timer, type LucideIcon } from "lucide-react";

export type SectionId = "actions" | "focus" | "archive" | "settings" | "evil-eye";
export type PrimarySectionId = "actions" | "focus";
...
export function syncSectionUrl(section: SectionId): void {
  ...
  const nextPath = section === "focus" ? "/focus" : section === "evil-eye" ? "/evil-eye" : "/";
...
export function isPrimarySection(section: SectionId): section is PrimarySectionId {
  return section === "actions" || section === "focus";
}
...
function isSectionId(value: unknown): value is SectionId {
  return value === "actions" || value === "focus" || value === "archive" || value === "settings" || value === "evil-eye";
}
