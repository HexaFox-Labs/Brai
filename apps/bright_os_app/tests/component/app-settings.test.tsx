...
describe("BrightOsApp settings", () => {
  ...
  it("shows when an Android OTA update is ready for restart", async () => {
    ...
    expect(screen.getByText("0.0.3.1 (1)")).toBeInTheDocument();
  });
  ...
  it.each([
    ...
    [
      "/data/user/0/world.brightos.bright_os_client/cache/bright-ota-downloads/0.0.4.1.zip: open failed: ENOENT (No such file or directory)",
