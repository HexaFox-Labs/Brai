# Bright OS Release Runbook

## Public Baseline

- Source baseline version: `0.0.1.1`.
- Web client: Next.js static export from `apps/bright_os_app/out`, published operationally to `deploy/web`.
...
- Android web-layer OTA uses the Bright OS native loader and Capacitor's local server path.
