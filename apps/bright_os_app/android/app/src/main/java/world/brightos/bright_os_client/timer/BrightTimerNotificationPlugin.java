...
@CapacitorPlugin(
    name = "BrightTimerNotification",
    permissions = {
        @Permission(alias = "notifications", strings = { Manifest.permission.POST_NOTIFICATIONS })
    }
)
public class BrightTimerNotificationPlugin extends Plugin {
    ...
    public void stop(PluginCall call) {
        BrightTimerNotificationService.stop(getContext());
        call.resolve();
    }
    ...
    private void startService(PluginCall call) {
        Intent intent = new Intent(getContext(), BrightTimerNotificationService.class);
        intent.setAction(BrightTimerNotificationService.ACTION_START);
        intent.putExtra(
            BrightTimerNotificationService.EXTRA_STARTED_AT_UTC,
