...
public final class BrightOtaWebViewClient extends BridgeWebViewClient {
    private final BrightOtaManager manager;

    public BrightOtaWebViewClient(Bridge bridge, BrightOtaManager manager) {
        super(bridge);
